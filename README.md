...
面向A股宏观与行业研究的晨间投资看板，辅助1—3个月波段观察。看板整合A股、港股通及海外参考市场数据，重点展示市场环境、重大新闻、大宗商品、宏观利率、行业强度、跨市场情绪、风险压力和未来催化。
...
- **重大新闻**：美国、欧洲、日韩政要及主要央行发言，地缘冲突、原油与航运风险；保留来源、发布时间或首次监测时点。
- **航运要道**：霍尔木兹海峡、曼德海峡与苏伊士运河每日通行船舶、油轮数量和7/28日均值对比。
- **大宗商品**：能源、贵金属、有色、黑色及新能源材料主力连续合约收盘价、日涨跌和近5个交易日涨跌。
...
- 07:30时A股尚未开盘，因此A股及国内商品行情使用上一已完成交易日；海外、新闻、航运和宏观指标使用当时已发布的最新有效值。
...
本仓库的源代码及原创软件文档采用 [MIT License](LICENSE) 开源许可。

MIT License 不覆盖第三方行情、新闻、指数等内容，也不覆盖 `data/current-snapshot.json`、`data/snapshots/` 和 `reports/daily/` 中的数据快照及日报。上述材料可能受各上游提供方的版权、数据库权利和使用条款约束；本仓库不对第三方材料授予任何额外权利。
